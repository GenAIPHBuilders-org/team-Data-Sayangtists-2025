...
const mockEntriesSummary: JournalEntrySummary[] = [
  ...
  },
  {
    id: '3',
    title: 'Weekend Plans',
    snippet: 'Looking forward to relaxing...',
    date: 'Apr 27, 2025',
  },
];
...
function App() {
  ...
  const [mainContentView, setMainContentView] = useState<'welcome' | 'loading' | 'detail'>(
    'welcome'
  );
  ...
  const handleSaveEntry = (title: string, content: string) => {
    ...
    console.warn(
      'Mock save complete. Detail view may not load correctly without backend integration.'
    );
  };
  ...
  return (
    <Flex h="100vh" w="100vw" overflow="hidden">
      ...
      />
      <MainContent viewState={mainContentView} entryData={selectedEntryData} />
      <NewEntryModal isOpen={isModalOpen} onClose={handleCloseModal} onSave={handleSaveEntry} />
    </Flex>
  );
}
